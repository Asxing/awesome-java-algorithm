...
public class BinarySearchTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Z字形遍历:");
        System.out.println(traversalTree.zigzagLevelOrder(binarySearchTree.tree));
        System.out.println();
        System.out.println("从左到右层级遍历:");
        System.out.println(traversalTree.levelOrderLeft2Right(binarySearchTree.tree));
        System.out.println();
        System.out.println("从右到左层级遍历:");
        System.out.println(traversalTree.levelOrderRight2Left(binarySearchTree.tree));
        int delete = 8;
